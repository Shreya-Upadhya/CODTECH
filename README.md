...
![Product Design](https://img.shields.io/badge/Product-Design-orange?style=for-the-badge)
![Healthcare](https://img.shields.io/badge/Healthcare-Design-green?style=for-the-badge)
...
This repository showcases UI/UX design projects created using Figma, demonstrating expertise in user interface design, user experience research, and digital product strategy. Each project represents a deep commitment to solving real-world problems through thoughtful, user-centered design.
...
### 📊 Project 1: Dashboard Design - Product Analytics

> A modern and clean dashboard design created in Figma to visualize product analytics, user activity, and server statistics.
...
- **📊 Website Traffic** – Donut chart showing registered users, visitors, and segments
- **📉 Total Downloads** – Line graph to track download growth trends
- **👥 Product Visitors** – Comparative line chart visualizing user activity over time
- **⭐ Most Active Users** – Sidebar widget highlighting top active users with profiles
- **📋 General Overview** – Weekly insights including new users count and download trends
- **🎯 Daily Goals Tracking** – Visual representation of daily achievements
- **🖥️ Server Statistics** – Monitors disk usage, bandwidth, memory, CPU load, and storage
- **🧭 Sidebar Navigation** – Quick access to dashboard sections via intuitive icons

---

### 🏥 Project 2: Healthcare Application - "Cliniq"

> A comprehensive healthcare application focusing on user experience and accessibility in medical services.

![Cliniq App Design 1](https://github.com/user-attachments/assets/37fc5e8a-9efc-4ad5-890f-0d5f849ee381)
![Cliniq App Design 2](https://github.com/user-attachments/assets/e835a17b-3fbc-4dd2-bdb7-8fee628fb6e6)

#### 🎯 Core Functionality

- **🔐 User Authentication** – Secure login and account creation system
- **❤️ Health Tracking** – Personal health monitoring and progress visualization
- **⚕️ Provider Selection** – Choose medical professionals based on preferences
...
- 🗺️ **User Journey Mapping** – Comprehensive flow analysis and touchpoint optimization
...
| Tool | Purpose |
|------|---------|
| **[Figma](https://www.figma.com/)** | Primary design and prototyping platform |

---

## 📞 Get in Touch

Interested in collaborating or viewing the full Figma files? Feel free to reach out!

---

<div align="center">

**Made with ❤️ by Shreya Upadhya**

⭐ If you find this portfolio helpful, please consider starring this repository!
